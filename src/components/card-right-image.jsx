    ...
    <>
        <div className="flex flex-col-reverse lg:flex-row justify-between gap-[2rem] h-auto items-center lg:mx-12">
            <div className="w-[80vw] lg:w-[60vw]">
                <div className="text-[20px] font-bold lg:text-[24px]">
                    {props.title}
                </div>
                <div>
            ...
            <div className="bg-white rounded-full h-[11rem] w-[11rem] lg:h-[12rem] lg:w-[12rem] flex justify-center items-center">
                <img src={img} className="w-[10rem] lg:w-[11rem]"/>
            </div>
        </div>
    </>
  );
