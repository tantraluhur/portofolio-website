...
function About() {
  return (
    <div className="grid gap-y-12">
        <div className="lg:text-[60px] text-[5.5vw] text-center font-bold font-[Inconsolata]">
            ABOUT ME
        </div>
        <div className="text-justify lg:text-[20px] text-[30px]">
        ...
        <div className="lg:text-[35px] text-[4vw] font-bold flex gap-x-[5vw]">
          <div className="flex justify-left items-center">
            Reach Me Out!
          </div>
          <div className="lg:text-[4.5vw] text-[8vw]">
